...
ActiveRecord::Schema[8.0].define(version: 2025_09_06_054034) do
  ...
  create_table "followings", force: :cascade do |t|
    ...
    t.index ["followed_id", "created_at"], name: "index_followings_on_followed_id_and_created_at"
    t.index ["followed_id", "follower_id"], name: "index_followings_on_followed_id_and_follower_id", unique: true
    t.index ["followed_id"], name: "index_followings_on_followed_id"
    t.index ["follower_id", "created_at"], name: "index_followings_on_follower_id_and_created_at"
    t.index ["follower_id"], name: "index_followings_on_follower_id"
  end

  create_table "sleep_records", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.datetime "clocked_in_at", default: -> { "CURRENT_TIMESTAMP" }, null: false
